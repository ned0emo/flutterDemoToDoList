    ...
    switch (code) {
      case 'invalid-email':
        return const SignUpWithEmailAndPasswordFailure(
          'Адрес электронной почты недействительный или имеет неверный формат.',
        );
      case 'user-disabled':
        return const SignUpWithEmailAndPasswordFailure(
...
class LogInWithEmailAndPasswordFailure implements Exception {
  ...
  factory LogInWithEmailAndPasswordFailure.fromCode(String code) {
    switch (code) {
      ...
      case 'user-not-found':
        return const LogInWithEmailAndPasswordFailure(
          'Адрес электронной почты не найден. Зарегестрируйтесь.',
        );
      case 'wrong-password':
        return const LogInWithEmailAndPasswordFailure(
          'Неверный пароль. Попробоуйте снова.',
        );
      default:
        return const LogInWithEmailAndPasswordFailure();
    }
